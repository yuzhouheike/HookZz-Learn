...
static int _logos_method$_ungrouped$CourseListItemModel$course_cache_permission(_LOGOS_SELF_TYPE_NORMAL CourseListItemModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
HBLogDebug(@"-[<CourseListItemModel: %p> course_cache_permission]", self);
	return 0;
}
...
static id _logos_method$_ungrouped$CQCourseCacheService$getDataFromDBWithSQL$(_LOGOS_SELF_TYPE_NORMAL CQCourseCacheService* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id sql){

	HBLogDebug(@"-[<CQCourseCacheService: %p> getDataFromDBWithSQL:%@]", self, sql);

	NSLog(@"%@", _logos_orig$_ungrouped$CQCourseCacheService$getDataFromDBWithSQL$(self, _cmd, sql));
	return _logos_orig$_ungrouped$CQCourseCacheService$getDataFromDBWithSQL$(self, _cmd, sql);
}
...
static id _logos_method$_ungrouped$WBSDKFMDatabase$extractSQL$argumentsList$intoString$arguments$(_LOGOS_SELF_TYPE_NORMAL WBSDKFMDatabase* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, id arg2, id arg3, id arg4) {

	 HBLogDebug(@"-[<WBSDKFMDatabase: %p> extractSQL:%@ argumentsList:%@ intoString:%@ arguments:%@]", self, arg1, arg2, arg3, arg4);

	 NSLog(@"%@", _logos_orig$_ungrouped$WBSDKFMDatabase$extractSQL$argumentsList$intoString$arguments$(self, _cmd, arg1, arg2, arg3, arg4));
	 return _logos_orig$_ungrouped$WBSDKFMDatabase$extractSQL$argumentsList$intoString$arguments$(self, _cmd, arg1, arg2, arg3, arg4);
}
...
static id _logos_method$_ungrouped$CQDBTool$DataBase$excuteSql$keyTypes$(_LOGOS_SELF_TYPE_NORMAL CQDBTool* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, id arg2, id arg3) {

	HBLogDebug(@"-[<CQDBTool: %p> DataBase:%@ excuteSql:%@ keyTypes:%@]", self, arg1, arg2, arg3);

	NSLog(@"%@", _logos_orig$_ungrouped$CQDBTool$DataBase$excuteSql$keyTypes$(self, _cmd, arg1, arg2, arg3));
	return _logos_orig$_ungrouped$CQDBTool$DataBase$excuteSql$keyTypes$(self, _cmd, arg1, arg2, arg3);
